...
const { isBearish, calculateBodySize } = require('../utils');
...
function detectThreeBlackCrows(candles, index) {
  ...
  const progression1 = (candle1.close - candle2.close) / candle1.close;
  const progression2 = (candle2.close - candle3.close) / candle2.close;
